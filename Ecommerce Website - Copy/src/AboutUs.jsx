    ...
    <div className="AboutUs flex flex-col items-center flex-grow h-full md:justify-normal justify-center">
      <div className="main flex flex-col h-1/2 items-center bg-white md:justify-normal justify-center">
        ...
        <p className="text-xl w-1/2 text-center md:mb-5">
          ...
          [Your Company Name], we strive to provide an exceptional online
          shopping experience for our customers. Our About Us page is the
          perfect opportunity to introduce ourselves and share our story with
          you.
        </p>
      </div>
        ...
        <div className="contentcontiner flex flex-col md:flex-row justify-center items-center md:justify-evenly">
          <div className="content w-1/2 md:h-screen ">
            <p className="text-xl w-full text-center md:m-20 font-medium">
              [Your Company Name] is an innovative and customer-centric online
              store that offers a wide range of high-quality products. We are
              passionate about connecting people with the products they need and
              love, all in one convenient online destination.
            </p>
          </div>
